...
export function mapFunction(input: Root): OutputRoot {
    const publication_count = mapObjectArrayToObject(input["Computer Vision"]);
    return {
        data: input["Computer Vision"],
        metadata: {
            count: publication_count
        },
        response: DM_PROPERTIES.SUCCESS_RESPONSE
    }
}

function mapObjectArrayToObject(data: Root["Computer Vision"]): any {
    return data.length;
}
